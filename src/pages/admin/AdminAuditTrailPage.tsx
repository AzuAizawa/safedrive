...
const actionLabels: Record<string, string> = {
  ...
  admin_deleted_vehicle: "Removed vehicle listing",
  admin_restored_vehicle: "Restored vehicle listing",
  account_deletion_scheduled: "Member scheduled their account for deletion",
  account_deletion_cancelled: "Member kept their account",
  account_deletion_notice_attempted: "Account deletion email sent",
  admin_account_deleted_with_notice: "Deleted an account with a reason",
