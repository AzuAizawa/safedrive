      ...
      <div className="container max-w-4xl mx-auto py-12 px-4 animate-fade-in">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-8 text-foreground/90 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-2"><strong>5.3 Final Balance:</strong> If the Renter chooses the 50% reservation downpayment, the remaining balance must be settled through the Platform before the designated rental start time.</p>
          ...
          <section>
            ...
            <p><strong>6.1 Renter Cancellation (Grace Period):</strong> After the downpayment is confirmed, the Renter has a 24-hour grace period during which they may cancel the booking and receive a full 100% refund without any cancellation fee.</p>
            <p className="mt-2"><strong>6.2 Renter Cancellation After the Grace Period:</strong> The system does not automatically apply a percentage penalty or automatically release money after the 24-hour refund window. The renter must contact support for documented review, and any refund, charge, or payout must match the approved decision and provider evidence.</p>
