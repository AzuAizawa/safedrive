...
// key (or absent), SafeDrive records payouts and cancellation refunds with
// the full ledger + notification + receipt trail but WITHOUT calling
// PayMongo. A live `sk_live_` key forces the real path.
