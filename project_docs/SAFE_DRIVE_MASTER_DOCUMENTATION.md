...
- **Add Vehicle** (`/my-vehicles`, initial listing): registration and CTPL expiry are required; comprehensive is optional. Documents required at this stage are OR/CR front+back and a CTPL document photo; a comprehensive insurance document photo is optional, matching its optional expiry date (CHAPTER 40 batch).
