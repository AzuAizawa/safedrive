...
- **A09 Security Logging and Alerting Failures:** security logs, audit logs, admin queues, and critical reconciliation notifications exist; external alert delivery, retention, and incident response remain hosting work.
